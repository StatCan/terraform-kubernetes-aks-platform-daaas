...
variable "kubernetes_rbac_daaas_group" {
  default = ""
}
...
variable "kubernetes_rbac_pachyderm_group" {
  description = "The rbac group for Pachyderm Users"
}

# Namespace groups
variable "groups_daaas" {
  type        = list(string)
  description = "List of groups with access to DAaaS namespaces"
}

variable "groups_esd" {
  type        = list(string)
  description = "List of groups with access to ESD namespaces"
}

variable "groups_pachyderm" {
  type        = list(string)
  description = "List of groups with access to Pachyderm namespaces"
}
